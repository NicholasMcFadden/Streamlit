...
def about_page():
    ...
    st.markdown("# About 🚀💻")
    st.image('media\st_teresa_cafe.jpg')
    ...
    st.markdown('''
                ...
                My conclusion was that my niche will be as the liason between the business and the technical side.  "Walking a mile in someone else's shoes" can give someone unparalled perspective.
                ...
                This is where I believe my talents will be best suited.  I am a naturally very curious person and Data Science in particular is exciting because at its core it's using advanced methods/mathematics/technology 
                to improve our understanding of the world around us. \n ''')
    ...
    st.markdown('''
                ...
                That is when I chose to go to Syracuse University for their Masters of Science in Business Analytics(MSBA). I decided to complete the MSBA rather than the MS in Data Science because at the forefront I wanted
    ...
    st.image('media\pico_malwee.jpg')
